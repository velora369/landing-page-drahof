...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <motion.a
        href={WHATSAPP_URL}
        className="relative flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-full shadow-xl border-2 border-white hover:shadow-green-500/50 hover:shadow-2xl transition-all duration-300"
